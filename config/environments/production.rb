...
module RouterWrapper
  ...
  MAPBOX_ACCESS_TOKEN = nil
  MAPBOX = Wrappers::MapBox.new(CACHE, access_token: MAPBOX_ACCESS_TOKEN, url_matrix: 'https://api.mapbox.com/directions-matrix/v1/mapbox/driving')
  HERE_APP_ID = nil
  HERE_APP_CODE = nil
